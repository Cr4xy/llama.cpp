...
- `hide-cache-models` (boolean): This option hides the automatially discovered models located in the cache directory. It is only supported in the global options.
